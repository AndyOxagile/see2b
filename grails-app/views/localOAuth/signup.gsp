					...
					<div class="form-box-inner">
						...
						<div class="row">
							<div class="form-container col-md-5 col-sm-12 col-xs-12">
								...
								<g:form action="createaccount" controller="oauth" method="post" autocomplete="off" class="signup-form">
									<fieldset>
										<div class="form-group email">
										<div class="fieldcontain ${hasErrors(bean: createAccountCommand, field: 'username', 'error')} form-group email">
											<label class="sr-only" for="signup-email">Your email</label>
											<g:textField name='username' value='${createAccountCommand?.username}' placeholder="Your email" id="signup-email" class="form-control login-email"/>
											<g:renderErrors bean="${createAccountCommand}" as="list" field="username"/>
										</div>
										<div class="fieldcontain ${hasErrors(bean: createAccountCommand, field: 'password1', 'error')} form-group password ">
											<label class="sr-only" for="signup-password">Your password</label>
											<g:passwordField name='password1' value='${createAccountCommand?.password1}' id="signup-password"  class="form-control login-password"/>
											<g:renderErrors bean="${createAccountCommand}" as="list" field="password1"/>
										</div>
										<div class="fieldcontain ${hasErrors(bean: createAccountCommand, field: 'password2', 'error')} form-group password ">
											<label class="sr-only" for="signup-password">Repeat password</label>
											<g:passwordField name='password2' value='${createAccountCommand?.password2}' id="signup-password2"  class="form-control login-password" />
											<g:renderErrors bean="${createAccountCommand}" as="list" field="password2"/>
										</div>
										<g:submitButton name="${message(code: 'springSecurity.oauth.registration.create.button', default: 'Sign up')}"  class="btn btn-block btn-cta-primary"/>
									</fieldset>
							...
							<div class="social-btns col-md-5 col-sm-12 col-xs-12 col-md-offset-1 col-sm-offset-0 col-sm-offset-0">
								...
								<ul class="list-unstyled social-login">
									...
									<li><oauth:connect  class="facebook-btn btn" provider="facebook" id="facebook-connect-link"><i class="fa fa-facebook"></i>Sign up with Facebook</oauth:connect></li>
									<li><oauth:connect  class="twitter-btn btn" provider="linkedin" id="linkedin-connect-link"><i class="fa fa-linkedin"></i>Sign up with LinkedIn</oauth:connect></li>
									<li><oauth:connect  class="google-btn btn" provider="google" id="google-connect-link"><i class="fa fa-google-plus"></i>Sign up with Google</oauth:connect></li>
								</ul>
