...
<html class=" js flexbox canvas canvastext webgl no-touch geolocation postmessage websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms csstransforms3d csstransitions fontface generatedcontent video audio localstorage sessionstorage webworkers applicationcache svg inlinesvg smil svgclippaths"><!--<![endif]--><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<title>See2B - Company Dashboard</title>
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="col-md-12" style="padding: 0">
						<section class="panel">
							<img src="../static/images/company/block111.png" alt="" style="width:100%;"/>
						</section>
					</div>
					<div class="col-md-12" style="padding: 0">
						<section class="panel">
							<img src="../static/images/company/block112.png" alt="" style="width:100%"/>
						</section>
					</div>
				</div>
				<div class="col-md-3">
					<div class="col-md-12" style="padding: 0">
						<section class="panel">
							<img src="../static/images/company/block121.png" alt="" style="width:100%"/>
						</section>
					</div>
					<div class="col-md-12" style="padding: 0">
						<section class="panel">
							<img src="../static/images/company/block122.png" alt="" style="width:100%"/>
						</section>
					</div>
				</div>
				<div class="col-md-3">
					<section class="panel">
						<img src="../static/images/company/block13.png" alt="" style="width:100%"/>
					</section>
				</div>
				<div class="col-md-3">
					<section class="panel">
						<img src="../static/images/company/block14.png" alt="" style="width:100%"/>
					</section>
				</div>
				<div class="col-md-12">
					<section class="panel">
